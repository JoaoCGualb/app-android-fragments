...
class NoticiaRepository(
    ...
    fun buscaTodos(): LiveData<Resource<List<Noticia>?>> {
        ...
        mediador.addSource(buscaInterno()) { noticiasEncontrada ->
            mediador.value = Resource(dado = noticiasEncontrada)
        }
        ...
        mediador.addSource(falhasDaWebApiLiveData) { resourceDeFalha->
            criaResourceNovo(resourceDeFalha)
        }
    ...
    private fun criaResourceNovo(resourceDeFalha: Resource<List<Noticia>?>) {
